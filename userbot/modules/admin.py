...
CmdHelp('cadmin').add_command(
        'cpromote', '<istifadəçi adı/cavab> <özəl ad (istəyə bağlıdır)>', 'Söhbətdəki birini admin edər.'
    ).add_command(
        ...
        'ckick', '<istifadəçi adı/cavab> <səbəbi (istəyə bağlıdır)>', 'Qrupdan qeyd etdiyiniz birini təpikləyər.'
    ).add_command(
