...
async def record_and_send_opus():
    ...
    status = await client.send_message(chat_id, "1/3 Yazılır...")
    ...
    await status.edit_text("3/3 Yüklənir...")
